...
void Tema2::Init()
{
    ...
    camera->Set(glm::vec3(auxPosOfCamera.x + 1.5f, auxPosOfCamera.y + 1.f, auxPosOfCamera.z), glm::vec3(auxPosOfCamera.x, auxPosOfCamera.y + 0.75f, auxPosOfCamera.z), glm::vec3(0, 1, 0));
